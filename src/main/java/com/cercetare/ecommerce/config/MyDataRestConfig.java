...
public class MyDataRestConfig implements RepositoryRestConfigurer {
    ...
    public void configureRepositoryRestConfiguration(RepositoryRestConfiguration config, CorsRegistry cors) {
        // Linia de mai jos era odata cu implementarea metodei.
        ...
        // configure cors mapping -> now we can delete @CrossOrigin annotation from all repos
...
/*
Info:
    facem acest lucru pentru a dezactiva posibilitatea ca orice utilizator sa poata efectua operatii de PUT, POST, DELETE pentru clasa Product
 */
